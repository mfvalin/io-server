...
//! Compute the space in megabytes taken by the given number of elements
static inline double num_elem_to_mb(const size_t num_elements) {
  return num_elements * sizeof(data_element) / (1024.0 * 1024.0);
}
